...
//go:generate swagger generate server --target ../../app --name Replicate --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/replicatecom/build/templates --principal interface{}

func configureFlags(api *operations.ReplicateAPI) {
...
func configureAPI(api *operations.ReplicateAPI) http.Handler {
