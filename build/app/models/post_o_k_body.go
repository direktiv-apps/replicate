...
type PostOKBody struct {
	...
	// replicate
	Replicate []*PostOKBodyReplicateItems `json:"replicate"`
}
...
func (m *PostOKBody) validateReplicate(formats strfmt.Registry) error {
	if swag.IsZero(m.Replicate) { // not required
		return nil
	}

	for i := 0; i < len(m.Replicate); i++ {
		if swag.IsZero(m.Replicate[i]) { // not required
			continue
		}

		if m.Replicate[i] != nil {
			if err := m.Replicate[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("replicate" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("replicate" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *PostOKBody) contextValidateReplicate(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.Replicate); i++ {

		if m.Replicate[i] != nil {
			if err := m.Replicate[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("replicate" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("replicate" + "." + strconv.Itoa(i))
